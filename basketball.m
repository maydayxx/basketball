function res = basketball(initSpeed, omegaInit, XYdistanceToBasket, angleToBasket, shotAngle, shotHeight, shotAngleVariation)
    ...
    %while aiming at the basket. All inputs are scalars. This function returns 
    %1 if the shot went in, and 0 if it missed. 
    ...
    %% This section runs the ode45 and plots x versus y
